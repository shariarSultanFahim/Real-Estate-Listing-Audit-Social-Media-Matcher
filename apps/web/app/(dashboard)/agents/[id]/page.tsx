  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <PageHeader
        ...
        backHref="/agents"
        icon={
          <div className="size-10 rounded-full bg-muted border border-primary/40 flex items-center justify-center text-primary text-base font-bold shrink-0">
            {agent.name.split(" ").map((n) => n[0]).join("")}
          </div>
        }
        title={agent.name}
        description={`${agent.email} • Phone: ${agent.phone || "N/A"}`}
      />
