  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-base font-semibold text-foreground">Photo Sequence &amp; Order Audit</h3>
          <p className="text-xs text-muted-foreground">Verifying photo sequence accuracy across syndication sites</p>
        </div>
        {photoDiscrepancy ? (
          ...
          >
            ...
            <div className="text-[11px] text-muted-foreground flex items-center justify-between">
              ...
              {photoDiscrepancy && index === 0 && (
                <span className="text-destructive font-semibold text-[10px]">Realtor: #2</span>
              )}
            </div>
          </div>
        ))}
